-- 🎯 修复 cancel_pc28_bet 函数：支持全局期数系统
-- 问题：函数使用的是旧的 pc28_game_rounds 表，现在应该使用 pc28_global_rounds 表
...
COMMENT ON FUNCTION public.cancel_pc28_bet IS '取消PC28下注：支持全局期数系统，兼容旧系统。退还用户余额，更新下注状态为cancelled。';
