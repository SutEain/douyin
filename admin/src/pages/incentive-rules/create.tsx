...
export const IncentiveRuleCreate = () => {
  ...
  return (
    <Create saveButtonProps={saveButtonProps}>
      <Form {...formProps} layout="vertical">
        ...
        >
          <Input placeholder="如：单作品获赞3" />
        </Form.Item>

        <Form.Item
          label="规则 Code（唯一）"
          name="code"
          rules={[{ required: true, message: '请输入规则 Code' }]}
        >
          <Input placeholder="如：video_like_3_reward" />
        </Form.Item>

        <Form.Item label="描述" name="description">
          <Input.TextArea rows={3} placeholder="规则说明（可选）" />
        </Form.Item>
        ...
        <Form.Item label="Scope" name="scope" initialValue="video">
          <Select>
        ...
        <Form.Item shouldUpdate>
          {() => {
            ...
            return (
              <>
                <Form.Item label="指标(metric)" name="metric" initialValue="like_count">
                  <Select>
        ...
        <Form.Item label="窗口(cap_window)" name="cap_window" initialValue="lifetime">
          <Select>
